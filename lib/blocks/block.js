...
exports.UniTrade = exports.UniOrder = exports.TokenGenesisBlock = exports.OpenWithReceiveTransferBlock = exports.ReceiveTransferBlock = exports.SendTransferBlock = exports.TransactionBlock = exports.CurrentServiceBlock = exports.SignedBlock = exports.Block = exports.LyraGlobal = exports.numberToBalanceBigInt = exports.toBalanceBigInt = void 0;
...
const toBalanceBigInt = (balance) => balance * BigInt(100000000);
exports.toBalanceBigInt = toBalanceBigInt;
const numberToBalanceBigInt = (value) => BigInt(Math.round(value * 100000000));
exports.numberToBalanceBigInt = numberToBalanceBigInt;
class LyraGlobal {
}
...
class SendTransferBlock extends TransactionBlock {
    ...
    toJson(wallet, sb) {
        ...
        this.Balances[sb.FeeTicker] =
            this.Balances[sb.FeeTicker] - (0, exports.toBalanceBigInt)(BigInt(sb.TransferFee));
        return super.toJson(wallet, sb);
    }
}
