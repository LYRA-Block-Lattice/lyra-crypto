...
exports.getUnreceivedBlocks = exports.receiveTransfer = exports.createNFTMeta = exports.uploadFile = exports.fetchDealer = exports.fetchTradesByOwner = exports.fetchOrdersByOwner = exports.fetchOrderById = exports.fetchOrders = exports.getBalance = exports.lastServiceHash = exports.getTradeForOrder = exports.GetLastBlock = exports.searchDao = exports.getHistory = exports.findFiatWallet = exports.getUnreceived = exports.mintToken = exports.recvTransferWithOpenAccount = exports.recvTransfer = exports.sendTransfer = exports.getLastServiceBlock = exports.getBlockExplorerUrl = exports.InitAxios = exports.setNetworkId = void 0;
const axios_1 = __importDefault(require("axios"));
let networkid = "devnet";
...
// Blockchain API V1
const getLastServiceBlock = () => Block_API_v1.get("/GetLastServiceBlock");
exports.getLastServiceBlock = getLastServiceBlock;
...
const recvTransfer = (receiveBlock) => Block_API_v1.post("/ReceiveTransfer", receiveBlock, {
    headers: {
        "Content-Type": "text/json"
    }
});
exports.recvTransfer = recvTransfer;
const recvTransferWithOpenAccount = (openReceiveBlock) => Block_API_v1.post("/ReceiveTransferAndOpenAccount", openReceiveBlock, {
    headers: {
        "Content-Type": "text/json"
    }
});
exports.recvTransferWithOpenAccount = recvTransferWithOpenAccount;
const mintToken = (tokenBlock) => Block_API_v1.post("/CreateToken", tokenBlock, {
    headers: {
        "Content-Type": "text/json"
    }
});
exports.mintToken = mintToken;
const getUnreceived = (accountId) => Block_API_v1.get("/LookForNewTransfer2?AccountId=" + accountId);
exports.getUnreceived = getUnreceived;
const findFiatWallet = (owner, symbol) => Block_API_v1.get("/FindFiatWallet?owner=" + owner + "&symbol=" + symbol);
exports.findFiatWallet = findFiatWallet;
const getHistory = (accountId, start, end, count) => {
    const toTicks = (date) => {
    ...
    return Block_API_v1.get("/SearchTransactions?accountId=" +
        accountId +
        "&startTimeTicks=" +
        toTicks(start) +
        "&endTimeTicks=" +
...
function receiveTransfer(finalJson) {
    throw new Error("Function not implemented.");
}
exports.receiveTransfer = receiveTransfer;
function getUnreceivedBlocks(accountId) {
    throw new Error("Function not implemented.");
}
exports.getUnreceivedBlocks = getUnreceivedBlocks;
