...
class LyraApi {
    ...
    async send(amount, destAddr, token) {
        try {
            ...
            console.log(`Current balance is: ${sendBlock.Balances[token] / block_1.LyraGlobal.BALANCERATIO}`);
            sendBlock.Balances[token] -= amount * block_1.LyraGlobal.BALANCERATIO;
