...
var LyraApi = /** @class */ (function () {
    ...
    LyraApi.prototype.send = function (amount, destAddr, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        balanceResp = _a.sent();
                        return [2 /*return*/, balanceResp.result];
                    case 4:
                        error_3 = _a.sent();
    ...
    LyraApi.prototype.history = function (startTimeUtc, endTimeUtc, count) {
        return __awaiter(this, void 0, void 0, function () {
            var histResult, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.ws.call("History", [
                            this.accountId,
                    ...
                    case 3:
                        histResult = _a.sent();
                        return [2 /*return*/, histResult.result];
                    case 4:
                        error_5 = _a.sent();
                        console.log("ws history error", error_5);
                        throw error_5;
                    case 5: return [2 /*return*/];
                }
            });
